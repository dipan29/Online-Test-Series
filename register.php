...
if (isset($_POST['register'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO users(name,email,phone,password,gender,dob,class,type) VALUES('" . $name . "', '" . $email . "', '" . $phone . "', '" . hash('sha512',$password) . "', '" .$gender . "', '" .$dob . "', '" .$class . "', '" .$type . "')" )) {
		
			$to = $email; 
			
			//Mailing Part
			$to = $email;
			$subject = 'Registration At '.$siteNameFull;
			...
			$message = '<html><body>';
			$message .= '<center><h1 style="color:blue !important" >'.$siteNameFull.'</h1></center>' . "<br><br>";
			$message .= 'Your Registration is Complete<br><br>';
			$message .= '<p style="font-size:18px;">Here are the details :-</p>';
			$message .= '<p>Name : '.$name.'</p>';
			$message .= '<p>Phone Number : '.$phone.'</p>';
			$message .= '<p>Password : '.$password.' (Store it in a safe place)</p>';
			$message .= 'We recomend to change your password once after login.<br>';
			$message .= '<br><p style="font-size:14px;">Please Click on this link, and check your test panel!</p>';
			$message .= '<p style="font-size:14px;"><a href="'.$siteUrl.'">Open '.$siteName.'</a></p><br>';
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="register.php"><i class="fa fa-plus"></i> Register New User</a></li>
          </ul>
        </li>
       	<li class="treeview">
          <a href="#">
