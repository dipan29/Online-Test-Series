      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="users.php"><i class="fa fa-eye"></i> View Users</a></li>                      
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <tr>
                  ...
                  <td>
                  <a class="btn btn-success" href="updateUser.php?id=<?php echo $row['id'] ; ?>">Update</a>&nbsp;
                  <a class="btn btn-warning" href="scripts/resetUserPass.php?id=<?php echo $row['id'] ; ?>">Reset Pass</a>&nbsp;
                  <?php if(($row['type'] == 'W')) {
					  //
				  }else{ ?>
                  <a class="btn btn-danger" href="scripts/deleteuser.php?id=<?php echo $row['id'] ; ?>">Delete</a>
                  <?php } ?>
                  </td>
                </tr>
                <?php }
