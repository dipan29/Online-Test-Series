...
if (isset($_POST['upload_image_2'])) {
	...
	$target = "../uploads/".$newfilename;
		...
		if(move_uploaded_file($_FILES['image']['tmp_name'], "../uploads/" . $newfilename)) {
			...
			$_SESSION['tmp_img_2'] = $contentAct;	
			$_SESSION['tmp_img_script_2'] = "<br><img src=".$link . $newfilename." alt=\"Image\"  width=\"100%\"><br>" ;
			$_SESSION['tmp_img_location_2'] = $newfilename ;
			?>
            <script>
				window.history.go(-1);
			</script>
